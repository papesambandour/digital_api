...
export declare enum TypeEvenEnum {
    ...
    MONEYGRAM_CALLBACK = "MONEYGRAM_CALLBACK",
    WAVE_MONEY_CALLBACK = "WAVE_MONEY_CALLBACK",
    ORANGE_MONEY_CALLBACK = "ORANGE_MONEY_CALLBACK",
    ORANGE_MONEY_CALLBACK_BAD_IP = "ORANGE_MONEY_CALLBACK_BAD_IP",
    FREE_MONEY_CALLBACK_BAD_IP = "FREE_MONEY_CALLBACK_BAD_IP",
    MONEYGRAM_CALLBACK_BAD_IP = "MONEYGRAM_CALLBACK_BAD_IP",
    MTN_BJ_MONEY_CALLBACK_BAD_IP = "MTN_BJ_MONEY_CALLBACK_BAD_IP",
    LAMP_CALLBACK_BAD_IP = "LAMP_CALLBACK_BAD_IP",
    WAVE_MONEY_CALLBACK_BAD_SHARED_KEY = "WAVE_MONEY_CALLBACK_BAD_SHARED_KEY",
    WAVE_MONEY_CALLBACK_BAD_TYPE = "WAVE_MONEY_CALLBACK_BAD_TYPE",
    MTN_MONEY_CALLBACK = "MTN_MONEY_CALLBACK",
    LAM_AIRTIME_CALLBACK = "LAM_AIRTIME_CALLBACK",
    HUB2_CALLBACK = "HUB2_CALLBACK",
    HUB2_CALLBACK_SIGN_MISMATCH = "HUB2_CALLBACK_SIGN_MISMATCH",
    ...
    BICTORIS_CALLBACK = "BICTORIS_CALLBACK",
    BICTORIS_CALLBACK_ERROR = "BICTORIS_CALLBACK_ERROR"
}
...
export declare enum SOUS_SERVICE_ENUM {
    ...
    MTN_BJ_API_CASH_OUT = "MTN_BJ_API_CASH_OUT",
    MTN_BJ_API_CASH_IN = "MTN_BJ_API_CASH_IN",
    MTN_CI_API_CASH_IN = "MTN_CI_API_CASH_IN",
    MTN_CI_API_CASH_OUT = "MTN_CI_API_CASH_OUT",
    ORANGE_SN_AIRTIME_CREDIT_TELEPHONIQUE = "ORANGE_SN_AIRTIME_CREDIT_TELEPHONIQUE",
    FREE_SN_AIRTIME_CREDIT_TELEPHONIQUE = "FREE_SN_AIRTIME_CREDIT_TELEPHONIQUE",
    EXPRESSO_SN_AIRTIME_CREDIT_TELEPHONIQUE = "EXPRESSO_SN_AIRTIME_CREDIT_TELEPHONIQUE",
    WAVE_SN_API_CASH_OUT = "WAVE_SN_API_CASH_OUT",
    WAVE_CI_API_CASH_OUT = "WAVE_CI_API_CASH_OUT",
    WAVE_CI_API_CASH_IN = "WAVE_CI_API_CASH_IN",
    ORANGE_CI_API_CASH_OUT = "ORANGE_CI_API_CASH_OUT",
    ORANGE_BF_API_CASH_OUT = "ORANGE_BF_API_CASH_OUT",
    ...
    MONEYGRAM_SN_API_CASH_OUT = "MONEYGRAM_SN_API_CASH_OUT",
    MONEYGRAM_SN_API_CASH_IN = "MONEYGRAM_SN_API_CASH_IN"
}
