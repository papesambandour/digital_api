...
export declare type HUB2_COUNTRY = 'bf' | 'ci' | 'cm';
export default class Hub2Provider {
    ...
    static apiManagerGetBalance(params: BalanceParams, country: HUB2_COUNTRY): Promise<BalanceResponse>;
    ...
    static getDeepLinkUrl(intentId: any, country: HUB2_COUNTRY): Promise<any>;
    static sendOtp(intentId: any, piToken: string, otpCode: string, country: HUB2_COUNTRY): Promise<any>;
    static waitForOtp(intentId: any, piToken: string, country: HUB2_COUNTRY): Promise<string>;
