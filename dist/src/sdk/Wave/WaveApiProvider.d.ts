...
export default class WaveApiProvider {
    ...
    static refundTransaction2(params: RefundParams, sessionId: string, transferId: string, type: 'payment' | 'deposit', token: string): Promise<RefundResponse>;
    static refundTransaction(params: RefundParams, sessionId: string, transferId: string, type: 'payment' | 'deposit', token: string): Promise<RefundResponse>;
    ...
    static getWaveTransactionDetailByBatchId(paymentBatchId: string, token: string): Promise<any>;
}
