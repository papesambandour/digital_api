...
class SeneauSnBillPaymentApiManagerService extends api_manager_interface_service_1.ApiManagerInterface {
    ...
    async initTransaction(params) {
        ...
        const billPayment = await WizallApiProvider_1.default.getInstance('payment').confirmBillSenEau(params.dto.billAccountNumber, params.dto.amount, params.dto.billReference, {
    ...
    async getPendingBillTransaction(params) {
        const response = await WizallApiProvider_1.default.getInstance('payment').getSenEauBillPayment(params.dto.billAccountNumber, {
