...
import { ResendCallbackDtoIn, ResendCallbackDtoOut, SetAutoStatusIn, SetAutoWaveDtoOut, SetFailedDtoIn, SetSuccessDtoIn, SetSuccessFailedDtoOut } from './dto/set-status';
...
export declare class PartnerServiceService {
    ...
    setAutoWaveStatus(setAutoStatusIn: SetAutoStatusIn): Promise<SetAutoWaveDtoOut>;
