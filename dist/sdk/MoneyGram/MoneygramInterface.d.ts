...
export interface MoneyGramReversalData {
    reversalDetails: {
        referenceNumber: string;
        operatorName: string;
        sendReversalReason: 'NO_RCV_LOC' | 'WRONG_SERVICE' | 'NO_TQ' | 'INCORRECT_AMT' | 'MS_NOT_USED';
        feeRefund: 'Y' | 'N';
        agentCheckType?: 'MTC';
...
export interface ReceptionServiceReceiveDetails {
    ...
    receiverPhotoIdType: 'ALN' | 'DRV' | 'GOV' | 'PAS' | 'STA';
    ...
    receivePurposeOfTransaction: 'EDUCATION_TRAIN' | 'GIFT' | 'BILLS' | 'FOOD' | 'MEDICAL' | 'PERSONAL_USE' | 'XFER_OWN_SAVNG';
    relationshipToSender: 'ACQUAINTANCE' | 'FAMILY' | 'FRIEND' | 'MYSELF' | 'COLLEAGUE';
    receiverIntendedUseOfMGIServices: 'BUSINESS_RELATED' | 'CHARITY_SUPPORT' | 'FAMILY_FRIENDS_SUPPORT' | 'THIRD_PARTY';
    receiverOccupation: 'ADMIN' | 'AGRICULTURE' | 'AUTOMOTIVE_SALES' | 'BANKING' | 'CLERGY' | 'COMPUTER' | 'CUSTOMER_CARE' | 'EDUCATION' | 'ENGINEER' | 'FACTORY' | 'HEALTH_SERVICES' | 'PUBLIC_OFFICIAL' | 'RESTAURANT' | 'RETIRED' | 'STUDENT' | 'NOT_EMPLOYED' | 'CONSULTING' | 'ENTERTAINMENT' | 'EXECUTIVE' | 'HUMAN_RESOURCES' | 'LEGAL' | 'PERSONAL_SERVICES' | 'SPORT' | 'ENTREPRENEUR';
...
export interface SendServiceSenderDetails {
    ...
    sendPurposeOfTransaction: 'EDUCATION_TRAIN' | 'GIFT' | 'BILLS' | 'FOOD' | 'MEDICAL' | 'PERSONAL_USE' | 'XFER_OWN_SAVNG';
    ...
    sourceOfFunds: 'FAMILY_FUNDS' | 'INHERITANCE' | 'LOAN' | 'LOTTERY_GAMBLING' | 'PENSION' | 'SALARY_EMPLOY' | 'SALE_OF_PROPERTY' | 'SAVINGS' | 'SOCIAL_BENEFITS' | 'THIRD_PARTY';
    relationshipToReceiver: 'ACQUAINTANCE' | 'FAMILY' | 'FRIEND' | 'MYSELF' | 'COLLEAGUE';
    senderOccupation: 'ADMIN' | 'AGRICULTURE' | 'AUTOMOTIVE_SALES' | 'BANKING' | 'CLERGY' | 'COMPUTER' | 'CUSTOMER_CARE' | 'EDUCATION' | 'ENGINEER' | 'FACTORY' | 'HEALTH_SERVICES' | 'PUBLIC_OFFICIAL' | 'RESTAURANT' | 'RETIRED' | 'STUDENT' | 'NOT_EMPLOYED' | 'CONSULTING' | 'ENTERTAINMENT' | 'EXECUTIVE' | 'HUMAN_RESOURCES' | 'LEGAL' | 'PERSONAL_SERVICES' | 'SPORT' | 'HOMEMAKER ' | 'SEAFARER  ' | 'ENTREPRENEUR';
    senderIntendedUseOfMGIServices: 'FAMILY_FRIENDS_SUPPORT' | 'BILL_PYMT';
}
...
export interface SendReversalRequestData extends Request {
    sendAmount: number;
    feeAmount: number;
    sendCurrency: Currency;
    referenceNumber: string;
    ...
    agentCheckNumber?: string;
    agentCheckAmount?: number;
    customerCheckType?: 'MTC';
    customerCheckNumber?: string;
    customerCheckAmount?: number;
    communicationRetryIndicator: boolean;
}
export interface SendReversalResponseData {
