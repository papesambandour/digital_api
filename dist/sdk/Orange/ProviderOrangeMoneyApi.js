    ...
    async sendTransaction(transaction) {
        ...
        try {
            ...
            const success = [
                ...
                ((_c = main_1.serializeData(apiResponse)) === null || _c === void 0 ? void 0 : _c.includes('Gateway Timeout'));
            return {
                success,
                code: success
                    ? 'success'
    ...
    async initQrCodeMerchantPayment(transaction, partnerName, callbackSuccess, callbackFailed) {
        try {
            ...
            const postOption = {
                ...
                headers: {
                    Authorization: `Bearer ${this.authToken}`,
                    'X-Callback-Url': 'https://api.intech.sn/api-services/callback/om-qr-sn',
                },
                simple: true,
            };
            console.log(formData);
            ...
            return {
                ...
                deepLinks: apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.deepLinks,
                code: success
                    ? 'success'
                    : ProviderOrangeMoneyApi.getAPiErrorCode((apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.description) || (apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.detail)),
                message: 'OK',
    ...
    async checkQrCodeTransactionStatus(transaction, helper) {
        ...
        try {
            ...
            const endDate = helper
                ...
                .toISOString()
                .substring(0, 19);
            const sendUrl = `${ProviderOrangeMoneyApi.appUrl}/api/eWallet/v1/transactions?reference=INTECH-OM-${transaction.transactionId}`;
            const postOption = {
                uri: sendUrl,
                method: 'GET',
                json: true,
            ...
            const apiResponse = await rp(postOption);
            let transactionResponse = Array.from(apiResponse).find((t) => {
                var _a;
                return (t === null || t === void 0 ? void 0 : t.metadata.reference_id) ===
                    `INTECH-OM-${transaction.transactionId}` &&
                    ((_a = t === null || t === void 0 ? void 0 : t.status) === null || _a === void 0 ? void 0 : _a.toUpperCase()) === 'SUCCESS';
            });
            if (!transactionResponse) {
                transactionResponse =
                    Array.from(apiResponse).find((t) => (t === null || t === void 0 ? void 0 : t.metadata.reference_id) ===
                        `INTECH-OM-${transaction.transactionId}`) || {};
            }
            let success;
            let code;
