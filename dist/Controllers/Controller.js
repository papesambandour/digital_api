...
exports.CODE_HTTP = {
    ...
    ACCOUNT_NO_ENABLED_FOR_PRODUCTION: 'ACCOUNT_NO_ENABLED_FOR_PRODUCTION',
    SAME_TRANSACTION_WITHIN_ONE_MINUTE_INTERVAL: 'SAME_TRANSACTION_WITHIN_ONE_MINUTE_INTERVAL',
...
exports.CODE_HTTP_OBJECT = {
    ...
    ACCOUNT_NO_ENABLED_FOR_PRODUCTION: {
        code: 4000,
        msg: "Le compte n'est pas autorisé a faire des transaction au dela de 300 CFA, Veuillez contacter le support pour faire des transaction en production",
    },
    SAME_TRANSACTION_WITHIN_ONE_MINUTE_INTERVAL: {
        code: 4000,
        msg: "Vous venez de faire le meme transaction en moins d'une minute d'interval sur intech api",
    },
    SERVICE_DOWN: {
        code: 4000,
