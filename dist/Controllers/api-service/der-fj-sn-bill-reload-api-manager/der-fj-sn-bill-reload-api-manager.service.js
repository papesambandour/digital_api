...
exports.DerFjSnBillReloadApiManagerService = void 0;
...
class DerFjSnBillReloadApiManagerService extends api_manager_interface_service_1.ApiManagerInterface {
    ...
    async initTransaction(params) {
        ...
        const rapido = await WaveApiProvider_1.default.makeDirectBillPay({
            ...
            otherFields: [
                {
                    name: 'mobile_number',
                    value: params.dto.phone,
                },
            ],
            label: 'Le DER/FJ',
            billId: WaveApiProvider_1.WAVE_BILL_ID.DER_FJ,
        });
...
exports.DerFjSnBillReloadApiManagerService = DerFjSnBillReloadApiManagerService;
//# sourceMappingURL=der-fj-sn-bill-reload-api-manager.service.js.map