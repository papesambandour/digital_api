...
class WaveMoneySnCashInApiManagerService extends api_manager_interface_service_1.ApiManagerInterface {
    ...
    async refundTransaction(params) {
        ...
        const response = await WaveApiProvider_1.default.refundTransaction(params, await config_1.waveBusinessApiConfig(this.constructor.country).sessionId(), params.transaction.sousServiceTransactionId, 'deposit', await config_1.waveBusinessApiConfig(this.constructor.country)
            .cashOutApiKey);
