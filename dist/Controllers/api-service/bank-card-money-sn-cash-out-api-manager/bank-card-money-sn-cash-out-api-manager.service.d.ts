import { ApiManagerInterface, BalanceParams, BalanceResponse, CallbackParams, CheckParams, CheckResponse, ConfirmParams, ConfirmResponse, CallbackResponse, InitParams, InitResponse, RefundResponse, RefundParams } from '../api-manager-interface/api-manager-interface.service';
export declare class BankCardMoneySnCashOutApiManagerService extends ApiManagerInterface {
