...
exports.XeweulSnBillReloadApiManagerService = void 0;
...
class XeweulSnBillReloadApiManagerService extends api_manager_interface_service_1.ApiManagerInterface {
    ...
    async initTransaction(params) {
        ...
        const rapido = await WaveApiProvider_1.default.makeDirectBillPay({
            ...
            billAccountNumberFieldName: 'ageroute_card_number',
            label: 'La carte Xeweul',
            billId: WaveApiProvider_1.WAVE_BILL_ID.XEWEUL,
        });
...
exports.XeweulSnBillReloadApiManagerService = XeweulSnBillReloadApiManagerService;
//# sourceMappingURL=xeweul-sn-bill-reload-api-manager.service.js.map