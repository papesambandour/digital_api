...
exports.OolusolarSnBillReloadApiManagerService = void 0;
...
class OolusolarSnBillReloadApiManagerService extends api_manager_interface_service_1.ApiManagerInterface {
    ...
    async initTransaction(params) {
        ...
        const rapido = await WaveApiProvider_1.default.makeDirectBillPay({
            ...
            billId: WaveApiProvider_1.WAVE_BILL_ID.OOLUSOLAR,
        });
...
exports.OolusolarSnBillReloadApiManagerService = OolusolarSnBillReloadApiManagerService;
//# sourceMappingURL=oolusolar-sn-bill-reload-api-manager.service.js.map