...
exports.MtnCiCashOutApiManagerService = void 0;
...
class MtnCiCashOutApiManagerService extends api_manager_interface_service_1.ApiManagerInterface {
    async checkStatusTransaction(params) {
        return await MtnApiProvider_1.MtnApiProvider.checkOperationStatus(this, params, config_1.mtnApiConfig(MtnCiCashOutApiManagerService.country).collection);
    }
    async confirmTransaction(params) {
        return await this.notImplementedYet(params);
    }
    async getBalance(params) {
        return await MtnApiProvider_1.MtnApiProvider.getBalance(config_1.mtnApiConfig(MtnCiCashOutApiManagerService.country).collection);
    }
    ...
    async initTransaction(params) {
        ...
        }, config_1.mtnApiConfig(MtnCiCashOutApiManagerService.country).collection, `payer: Paiement de ${transaction.amount} CFA sur ${partner.name}`, `payee: Paiement de ${transaction.amount} CFA sur ${partner.name}`);
...
exports.MtnCiCashOutApiManagerService = MtnCiCashOutApiManagerService;
MtnCiCashOutApiManagerService.country = 'ci';
//# sourceMappingURL=mtn-ci-cash-out-api-manager.service.js.map