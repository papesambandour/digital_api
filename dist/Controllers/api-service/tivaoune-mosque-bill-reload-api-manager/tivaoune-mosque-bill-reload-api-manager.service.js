...
exports.TivaouneMosqueBillReloadApiManagerService = void 0;
...
class TivaouneMosqueBillReloadApiManagerService extends api_manager_interface_service_1.ApiManagerInterface {
    ...
    async initTransaction(params) {
        ...
        const rapido = await WaveApiProvider_1.default.makeDirectBillPay({
            ...
            successMessage: 'Votre participation a la grande mosquée de Tivaoune bien été envoyé',
            billId: WaveApiProvider_1.WAVE_BILL_ID.TIVAOUNE_MOSQUE,
            searchInSummary: 'Mosquée de Tivaouane',
        });
...
exports.TivaouneMosqueBillReloadApiManagerService = TivaouneMosqueBillReloadApiManagerService;
//# sourceMappingURL=tivaoune-mosque-bill-reload-api-manager.service.js.map