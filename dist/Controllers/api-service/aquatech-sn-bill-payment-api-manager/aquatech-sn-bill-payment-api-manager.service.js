...
exports.AquatechSnBillPaymentApiManagerService = void 0;
...
class AquatechSnBillPaymentApiManagerService extends api_manager_interface_service_1.ApiManagerInterface {
    ...
    async initTransaction(params) {
        ...
        const billPayment = await WaveApiProvider_1.default.confirmBill({
            ...
            billId: WaveApiProvider_1.WAVE_BILL_ID.AQUATECH,
...
exports.AquatechSnBillPaymentApiManagerService = AquatechSnBillPaymentApiManagerService;
//# sourceMappingURL=aquatech-sn-bill-payment-api-manager.service.js.map