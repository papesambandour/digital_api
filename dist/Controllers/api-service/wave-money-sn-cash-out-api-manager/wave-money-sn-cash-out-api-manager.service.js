...
class WaveMoneySnCashOutApiManagerService extends api_manager_interface_service_1.ApiManagerInterface {
    ...
    async initTransaction(params) {
        ...
        if (checkout === null || checkout === void 0 ? void 0 : checkout.success) {
            ...
            if (this.constructor.country === 'ci') {
    ...
    async refundTransaction(params) {
        ...
        const response = await WaveApiProvider_1.default.refundTransaction(params, await config_1.waveBusinessApiConfig(this.constructor.country).sessionId(), params.transaction.sousServiceTransactionId, 'payment', await config_1.waveBusinessApiConfig(this.constructor.country)
            .cashOutApiKey);
