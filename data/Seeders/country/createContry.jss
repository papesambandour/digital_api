...
let countries =[
    ...
    },
    {
        ...
        "regionalBlocs": [
            ...
            },
            {
                ...
                "otherAcronyms": [],
                "otherNames": [
                    "Ø¬Ø§ÙØ¹Ø© Ø§ÙØ¯ÙÙ Ø§ÙØ¹Ø±Ø¨ÙØ©",
    ...
    },
    {
        ...
        "translations": {
            ...
            "es": "Liechtenstein",
            "fr": "Liechtenstein",
            "ja": "ãªããã³ã·ã¥ã¿ã¤ã³",
            "it": "Liechtenstein",
            "br": "Liechtenstein",
            "pt": "Listenstaine",
            "nl": "Liechtenstein",
            "hr": "LihtenÅ¡tajn",
            "fa": "ÙÛØ®ØªÙâØ§Ø´ØªØ§ÛÙ"
        },
    ...
    },
    {
        ...
        "altSpellings": [
            ...
            "Ð ÐµÐ¿ÑÐ±Ð»Ð¸ÐºÐ° ÐÐ°ÐºÐµÐ´Ð¾Ð½Ð¸ÑÐ°"
        ],
        "region": "Europe",
        "subregion": "Southern Europe",
        "population": 2058539,
        ...
        "nativeName": "ÐÐ°ÐºÐµÐ´Ð¾Ð½Ð¸ÑÐ°",
        "numericCode": "807",
        "currencies": [
            {
                "code": "MKD",
        ...
        "translations": {
            ...
            "es": "Macedonia",
            "fr": "MacÃ©doine",
            "ja": "ãã±ããã¢æ§ã¦ã¼ã´ã¹ã©ãã¢å±åå½",
            "it": "Macedonia",
            "br": "MacedÃ´nia",
            "pt": "MacedÃ³nia",
            "nl": "MacedoniÃ«",
        ...
        "languages": [
            {
                ...
                "iso639_2": "zsm",
                "name": "Malaysian",
                "nativeName": "Ø¨ÙØ§Ø³ ÙÙÙØ³ÙØ§"
            }
        ],
        "translations": {
            "de": "Malaysia",
    ...
    },
    {
        ...
        "translations": {
            ...
            "nl": "MicronesiÃ«",
            "hr": "Mikronezija",
            "fa": "Ø§ÛØ§ÙØ§Øª ÙØ¯Ø±Ø§Ù ÙÛÚ©Ø±ÙÙØ²Û"
        },
    ...
    },
    {
        ...
        "altSpellings": [
            ...
            "Pyidaunzu ThanmÄda MyÄma Nainngandaw"
        ],
        "region": "Asia",
        "subregion": "South-Eastern Asia",
        "population": 51419420,
...
let sql = `INSERT INTO country (name, flag, code, calling_codes,capital,state, created_at) VALUES  `;
let now = (new Date()).toISOString().replace('T',' ').substr(0,19)
for(let i = 0;i< countries.length;i++){
    let country = countries[i];
    sql += ` ( '${country.name.replaceAll("'"," ")}' , '${country.flag}' , '${country.alpha3Code.replaceAll("'"," ")}' , '${country.callingCodes[0]}' ,'${country.capital.replaceAll("'"," ")}','ACTIVED' ,'${now}'),`
}
window.document.write(sql);*/
